...
public class noteActivity extends AppCompatActivity {
    ...
    public void deleteNote(View view) {
        ...
        String newValue = Integer.toString(Integer.parseInt(getExp()) + 1);
        SQLiteDatabase expdb = expDbHelper.getWritableDatabase();
        args.put(ExpContract.ExpEntry.COL_EXP,newValue);
        expdb.update(ExpContract.ExpEntry.TABLE, args, null, null);
        expdb.close();
        updateUI();
    }
